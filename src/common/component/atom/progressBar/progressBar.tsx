    ...
    <div className={classNames('flex flex-col gap-y-1', parentClassName)}>
      ...
      <div className="flex relative items-center w-full gap-x-3">
        <div className="w-full h-3 bg-[#c8cbcf] rounded-2xl">
          <div style={{ width: `${Percent}%` }} className={classNames(`relative h-3 rounded-2xl bg-[#35B34A]`, className)}></div>
        </div>
        <Text className="text-center mt-1 absolute right-auto left-auto w-full text-[0.7rem] text-white" fontWeight="medium">
          {score}%
        </Text>
      </div>
    </div>
