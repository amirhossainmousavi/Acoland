    ...
    <>
      <header
        className={classNames(
          "z-50 flex items-center justify-center w-full h-20 px-3 text-lg bg-transparent print:hidden pwa:hidden text-slate-700 md:px-4 md:h-20 border-slate-100 md:mt-4 md:w-[85%] md:rounded-lg mt-0 rounded-none absolute left-0 right-0 mx-auto",
          {
            "bg-[#08004D] md:mt-0 md:w-full md:h-24 rounded-b-3xl":
              isSpecialRoute,
          }
        )}
      >
        <div
          className={classNames(
            "container relative items-center hidden w-full h-full mx-auto md:flex gap-4",
            {
        ...
        >
          ...
          {isDesktop && (
            <nav className="flex justify-between w-full items-center">
              ...
              <Button
                className="flex gap-2 rounded-[2rem] bg-[#35B34A] border-none font-medium "
