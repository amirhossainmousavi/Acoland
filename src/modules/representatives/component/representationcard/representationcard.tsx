...
export const Representationcard = (props: RepresentationcardProps) => {
    ...
    return <div className="w-full py-4 items-center flex border-solid border-b-2">
        <div onClick={() => router.push(`/representative/${slug}`)} className="w-[25%] md:w-[20%] flex justify-center items-center gap-3 cursor-pointer">
        ...
        <div onClick={() => location.assign(`tel:${phonNumber}`)} className="bg-[#08004D] rounded-lg p-1 cursor-pointer relative -left-3 md:-left-14"> 
