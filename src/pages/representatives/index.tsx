...
const Representatives:NextPageWithLayout =() => {
    ...
    return <>
        <div className="w-full flex flex-col gap-3 items-center justify-center h-[40rem] bg-white bg-no-repeat bg-cover bg-center" style={{backgroundImage:`url(${publicRuntimeConfig.LIARA_IMAGE_S3_HOST}/Representatives/Header-representatives.png`}}>
            ...
            <Text fontSize={isDesktop ? 'lg' : 'base'} fontWeight='bold' className='block text-white text-center'>با همکاری نمایندگان ما در آکولند، با آرامش خاطر، به سرمایه‌گذاری خود ادامه دهید</Text>
            <Text fontSize={isDesktop?'base' : 'sm'} className='block text-white md:w-[65%] text-center leading-7'>با نمایندگی‌های ما در آکولند، بهترین فرصت‌های خرید زمین و املاک را کشف کنید
