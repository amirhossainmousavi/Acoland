  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage: `url(${publicRuntimeConfig.LIARA_IMAGE_S3_HOST}/Representatives/Header-representatives.png`,
        }}
      >
        <div className="w-[85%] h-full flex flex-col gap-3 items-center justify-center">
          ...
          >
            در آکولند، با اطمینان و آرامش به سرمایه‌گذاری بپردازید.
          </Text>
          <Text
            fontSize={isDesktop ? "base" : "sm"}
            className="block text-white md:w-[65%] text-center leading-7"
          >
            کارشناسان ما همراه شما هستند تا از میان بهترین امکانات و فرصت‌های
            بازار املاک، گزینه‌های برتر را برایتان به ارمغان بیاورند. تخصص و
            تجربه ما، تضمینی بر انتخاب‌های هوشمندانه شماست.
          </Text>
        </div>
      </div>
...
Representatives.getLayout = function getLayout(
  representativesPage: ReactElement
) {
  return (
    <LayoutWithHeaderAndFooter>{representativesPage}</LayoutWithHeaderAndFooter>
  );
};
